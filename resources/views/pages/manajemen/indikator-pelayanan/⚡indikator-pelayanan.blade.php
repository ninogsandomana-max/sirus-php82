        ...
        <div class="px-6 py-10 space-y-8">
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                    <a href="{{ route('manajemen.rs.satu-sehat.monitoring-satu-sehat') }}" wire:navigate
                        class="flex items-start gap-3 p-4 transition-colors bg-canvas border border-hairline group rounded-xl hover:bg-brand-green/10 hover:border-brand-green/40 dark:border-gray-700 dark:bg-gray-900 dark:hover:bg-brand-lime/10">
                        <span class="inline-flex items-center justify-center w-9 h-9 rounded-lg bg-teal-50 text-teal-700 group-hover:bg-teal-100 dark:bg-teal-900/30 dark:text-teal-400">
                        ...
                        <div class="min-w-0">
                            <div class="font-semibold text-ink dark:text-gray-100">Monitoring Pengiriman SATUSEHAT</div>
                            <div class="mt-0.5 text-xs text-muted dark:text-gray-400">
                                Kunjungan sudah/belum terkirim per bulan &mdash; capaian kelengkapan &amp; konsistensi
                            </div>
                        </div>
                    </a>

                    <a href="{{ route('manajemen.rs.vclaim.laporan-rujukan-keluar') }}" wire:navigate
                        class="flex items-start gap-3 p-4 transition-colors bg-canvas border border-hairline group rounded-xl hover:bg-brand-green/10 hover:border-brand-green/40 dark:border-gray-700 dark:bg-gray-900 dark:hover:bg-brand-lime/10">
                        ...
                        <div class="min-w-0">
                            <div class="font-semibold text-ink dark:text-gray-100">Evaluasi Rujukan Keluar RS</div>
                            <div class="mt-0.5 text-xs text-muted dark:text-gray-400">
                                Rujukan keluar (VClaim) &mdash; poli &amp; dokter perujuk, faskes tujuan, diagnosa rujukan
                            </div>
                        </div>
                    </a>

                    {{-- Pasangan cermin dari Evaluasi Rujukan Keluar. Ikon panah masuk (kiri)
                         sengaja dipilih agar keduanya terbaca sebagai satu pasangan arah. --}}
                    <a href="{{ route('manajemen.rs.vclaim.laporan-rujukan-masuk') }}" wire:navigate
                        class="flex items-start gap-3 p-4 transition-colors bg-canvas border border-hairline group rounded-xl hover:bg-brand-green/10 hover:border-brand-green/40 dark:border-gray-700 dark:bg-gray-900 dark:hover:bg-brand-lime/10">
                        ...
                        <div class="min-w-0">
                            <div class="font-semibold text-ink dark:text-gray-100">Evaluasi Rujukan Masuk RS</div>
                            <div class="mt-0.5 text-xs text-muted dark:text-gray-400">
                                Rujukan masuk Rawat Jalan &mdash; faskes perujuk, poli penerima, diagnosa rujukan
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('manajemen.rs.ri.laporan-surveilans-hais') }}" wire:navigate
                        ...
                        <span class="inline-flex items-center justify-center w-9 h-9 rounded-lg bg-red-50 text-red-700 group-hover:bg-red-100 dark:bg-red-900/30 dark:text-red-300">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M9 12l2 2 4-4m-8.165-5.303a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                            </svg>
                        </span>
                        <div class="min-w-0">
                            <div class="font-semibold text-ink dark:text-gray-100">Laporan Surveilans HAIs</div>
                            <div class="mt-0.5 text-xs text-muted dark:text-gray-400">
                                Insiden rate bulanan IAD, Plebitis, ISK, VAP &amp; ILO &mdash; kasus / hari pemakaian alat
                            </div>
                        </div>
                    </a>
