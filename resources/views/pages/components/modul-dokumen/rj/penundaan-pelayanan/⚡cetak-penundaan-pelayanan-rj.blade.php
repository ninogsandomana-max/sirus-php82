<?php
// resources/views/pages/components/modul-dokumen/rj/penundaan-pelayanan/cetak-penundaan-pelayanan-rj.blade.php
...
new class extends Component {
    ...
    public function open(int $rjNo, ?string $signatureDate = null): mixed
    {
        ...
        $pdf = Pdf::loadView('pages.components.modul-dokumen.rj.penundaan-pelayanan.cetak-penundaan-pelayanan-rj-print', ['data' => $data])->setPaper('A4');
