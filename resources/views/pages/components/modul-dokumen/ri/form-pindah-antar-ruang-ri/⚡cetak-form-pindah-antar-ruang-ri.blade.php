<?php
// resources/views/pages/components/modul-dokumen/ri/form-pindah-antar-ruang-ri/cetak-form-pindah-antar-ruang-ri.blade.php
...
new class extends Component {
    ...
    public function open(string $riHdrNo, string $tglPindah): mixed
    {
        ...
        $pdf = Pdf::loadView('pages.components.modul-dokumen.ri.form-pindah-antar-ruang-ri.cetak-form-pindah-antar-ruang-ri-print', ['data' => $data])->setPaper('A4');
