<?php
// resources/views/pages/components/modul-dokumen/bpjs/cetak-skdp/cetak-skdp.blade.php
...
new class extends Component {
    ...
    private function generatePdf(array $dataTxn, string $jenis): mixed
    {
        ...
        $pdf = Pdf::loadView('pages.components.modul-dokumen.bpjs.cetak-skdp.cetak-skdp-print', ['data' => $data])->setPaper('A5', 'landscape');
