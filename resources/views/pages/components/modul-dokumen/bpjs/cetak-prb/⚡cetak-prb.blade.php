<?php
// resources/views/pages/components/modul-dokumen/bpjs/cetak-prb/cetak-prb.blade.php
...
new class extends Component {
    ...
    private function generatePdf(array $dataTxn): mixed
    {
        ...
        $pdf = Pdf::loadView('pages.components.modul-dokumen.bpjs.cetak-prb.cetak-prb-print', ['data' => $data])
