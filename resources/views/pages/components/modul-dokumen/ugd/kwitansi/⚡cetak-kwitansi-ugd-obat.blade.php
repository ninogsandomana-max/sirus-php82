<?php
// resources/views/pages/components/modul-dokumen/ugd/kwitansi/cetak-kwitansi-ugd-obat.blade.php
...
new class extends Component {
    ...
    public function open(int $rjNo): mixed
    {
        ...
        // ── Generate PDF ──
        $pdf = Pdf::loadView('pages.components.modul-dokumen.ugd.kwitansi.cetak-kwitansi-ugd-obat-print', [
            'data' => $data,
        ])->setPaper('A4');
