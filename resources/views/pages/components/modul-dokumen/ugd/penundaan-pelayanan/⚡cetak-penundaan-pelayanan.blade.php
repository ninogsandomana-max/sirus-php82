<?php
// resources/views/pages/components/modul-dokumen/ugd/penundaan-pelayanan/cetak-penundaan-pelayanan.blade.php
...
new class extends Component {
    ...
    public function open(int $rjNo, ?string $signatureDate = null): mixed
    {
        ...
        $pdf = Pdf::loadView('pages.components.modul-dokumen.ugd.penundaan-pelayanan.cetak-penundaan-pelayanan-print', ['data' => $data])->setPaper('A4');
