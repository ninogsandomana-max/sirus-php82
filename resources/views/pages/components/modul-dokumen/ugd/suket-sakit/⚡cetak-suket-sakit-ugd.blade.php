<?php
// resources/views/pages/components/modul-dokumen/ugd/suket-sakit/cetak-suket-sakit-ugd.blade.php
...
new class extends Component {
    ...
    public function open(int $rjNo): mixed
    {
        ...
        $pdf = Pdf::loadView('pages.components.modul-dokumen.ugd.suket-sakit.cetak-suket-sakit-ugd-print', [
            'data' => $data,
        ])->setPaper('A4');
