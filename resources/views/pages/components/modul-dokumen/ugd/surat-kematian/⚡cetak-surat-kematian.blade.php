<?php
// resources/views/pages/components/modul-dokumen/ugd/surat-kematian/cetak-surat-kematian.blade.php
...
new class extends Component {
    ...
    public function open(int $rjNo): mixed
    {
        ...
        $pdf = Pdf::loadView('pages.components.modul-dokumen.ugd.surat-kematian.cetak-surat-kematian-print', ['data' => $data])->setPaper('A4');
