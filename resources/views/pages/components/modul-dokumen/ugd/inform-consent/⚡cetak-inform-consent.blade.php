<?php
// resources/views/pages/components/modul-dokumen/ugd/inform-consent/cetak-inform-consent.blade.php
...
new class extends Component {
    ...
    public function open(int $rjNo, ?string $signatureDate = null): mixed
    {
        ...
        $pdf = Pdf::loadView('pages.components.modul-dokumen.ugd.inform-consent.cetak-inform-consent-print', ['data' => $data])->setPaper('A4');
