<?php
// resources/views/pages/components/modul-dokumen/ugd/suket-sehat/cetak-suket-sehat-ugd.blade.php
...
new class extends Component {
    ...
    public function open(int $rjNo): mixed
    {
        ...
        $pdf = Pdf::loadView('pages.components.modul-dokumen.ugd.suket-sehat.cetak-suket-sehat-ugd-print', [
            'data' => $data,
        ])->setPaper('A4');
