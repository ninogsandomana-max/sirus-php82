<?php
// resources/views/pages/components/rekam-medis/ri/cetak-rekam-medis/cetak-rekam-medis-open.blade.php
//
    ...
    */
    ...
    public function ringkasPenilaian(string $jenisPenilaian, mixed $entriPenilaian): array
    {
        ...
        $hasil = match ($jenisPenilaian) {
            // Interpretasi nyeri dihitung ulang dari metode + skor (App\Support\Options\NyeriOptions)
        ...
        <div class="flex flex-col min-h-[calc(100vh-4rem)]" wire:key="preview-rekam-medis-ri-{{ $riHdrNo }}"
            ...
            <div class="flex-1 overflow-y-auto bg-surface-soft/70 dark:bg-gray-950/20">
                ...
                <div x-show="tab === 'asesmen'">
                    @include('pages.components.rekam-medis.ri.cetak-rekam-medis.asesmen-ri-tab')
                </div>
                ...
                <div x-show="tab === 'dokumen'" x-cloak class="px-6 py-5 space-y-5">
                    ...
                    <livewire:pages::components.rekam-medis.ri.dokumen-view.general-consent-view-ri :riHdrNo="(string) $riHdrNo"
                        :consent="$ri['generalConsentPasienRI'] ?? []" wire:key="rm-view-gc-ri-{{ $riHdrNo }}" />

                    {{-- ── Inform Consent — viewer (Lihat + Cetak dalam modal) ── --}}
                    <livewire:pages::components.rekam-medis.ri.dokumen-view.inform-consent-view-ri :riHdrNo="(string) $riHdrNo"
                    ...
                    @if ((string) ($ri['perencanaan']['tindakLanjut']['statusPulang'] ?? '') === '4')
                        <livewire:pages::components.rekam-medis.ri.dokumen-view.surat-kematian-view-ri :riHdrNo="(string) $riHdrNo"
                    ...
                    <livewire:pages::components.rekam-medis.ri.dokumen-view.edukasi-pasien-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['edukasiPasien'] ?? []" wire:key="rm-view-edukasi-pasien-{{ $riHdrNo }}" />

                    {{-- ── Edukasi Terintegrasi — viewer (Lihat + Cetak dalam modal) ── --}}
                    <livewire:pages::components.rekam-medis.ri.dokumen-view.edukasi-terintegrasi-view-ri :riHdrNo="(string) $riHdrNo"
                    ...
                    <livewire:pages::components.rekam-medis.ri.dokumen-view.form-pindah-view-ri :riHdrNo="(string) $riHdrNo"
                    ...
                    <livewire:pages::components.rekam-medis.ri.dokumen-view.pengkajian-pre-op-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['pengkajianPreOpRI'] ?? []" wire:key="rm-view-pengkajian-pre-op-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.pra-anestesi-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['praAnestesiRI'] ?? []" wire:key="rm-view-pra-anestesi-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.pra-induksi-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['praInduksiRI'] ?? []" wire:key="rm-view-pra-induksi-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.surgical-safety-checklist-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['surgicalSafetyChecklistRI'] ?? []" wire:key="rm-view-surgical-safety-checklist-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.laporan-operasi-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['laporanOperasiRI'] ?? []" wire:key="rm-view-laporan-operasi-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.laporan-anestesi-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['laporanAnestesiRI'] ?? []" wire:key="rm-view-laporan-anestesi-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.pasca-anestesi-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['pascaAnestesiRI'] ?? []" wire:key="rm-view-pasca-anestesi-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.instruksi-pasca-bedah-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['instruksiPascaBedahRI'] ?? []" wire:key="rm-view-instruksi-pasca-bedah-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.penundaan-pelayanan-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['penundaanPelayananRI'] ?? []" wire:key="rm-view-penundaan-pelayanan-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.permintaan-kerohanian-view-ri :riHdrNo="(string) $riHdrNo"
                    ...
                    <livewire:pages::components.rekam-medis.ri.dokumen-view.pengkajian-awal-obstetri-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['pengkajianAwalObstetriRI'] ?? []" wire:key="rm-view-pengkajian-awal-obstetri-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.riwayat-obstetri-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['riwayatObstetriRI'] ?? []" wire:key="rm-view-riwayat-obstetri-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.observasi-persalinan-view-ri :riHdrNo="(string) $riHdrNo"
                    ...
                    <livewire:pages::components.rekam-medis.ri.dokumen-view.observasi-nifas-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['observasiNifasRI'] ?? []" wire:key="rm-view-observasi-nifas-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.pengkajian-awal-ginekologi-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['pengkajianAwalGinekologiRI'] ?? []" wire:key="rm-view-pengkajian-awal-ginekologi-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.pengkajian-awal-bayi-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['pengkajianAwalBayiRI'] ?? []" wire:key="rm-view-pengkajian-awal-bayi-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.pengkajian-neonatal-perawat-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['pengkajianNeonatalPerawatRI'] ?? []" wire:key="rm-view-pengkajian-neonatal-perawat-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.identifikasi-bayi-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['identifikasiBayiRI'] ?? []" wire:key="rm-view-identifikasi-bayi-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.catatan-terapi-neonatal-view-ri :riHdrNo="(string) $riHdrNo"
                    ...
                    <livewire:pages::components.rekam-medis.ri.dokumen-view.surveilans-plebitis-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['surveilansPlebitisRI'] ?? []" wire:key="rm-view-surveilans-plebitis-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.surveilans-isk-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['surveilansIskRI'] ?? []" wire:key="rm-view-surveilans-isk-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.surveilans-vap-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['surveilansVapRI'] ?? []" wire:key="rm-view-surveilans-vap-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.surveilans-hap-view-ri :riHdrNo="(string) $riHdrNo"
                        :entries="$ri['surveilansHapRI'] ?? []" wire:key="rm-view-surveilans-hap-{{ $riHdrNo }}" />

                    <livewire:pages::components.rekam-medis.ri.dokumen-view.surveilans-ilo-view-ri :riHdrNo="(string) $riHdrNo"
