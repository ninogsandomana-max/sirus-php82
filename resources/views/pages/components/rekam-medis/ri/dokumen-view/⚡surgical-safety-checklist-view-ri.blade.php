<?php
// Viewer read-only "Surgical Safety Checklist" — display Rekam Medis RI.
...
new class extends Component {
    ...
    private string $printView = 'surgical-safety-checklist-ri.cetak-surgical-safety-checklist-ri-print';
    private string $filePrefix = 'surgical-safety-checklist-ri';
    ...
    public function lihat(string $id): void
    {
        ...
        $this->dispatch('open-modal', name: "view-surgical-safety-checklist-ri-{$this->riHdrNo}");
    }
...
<div>
    ...
    <x-rm.dokumen-view-modal name="view-surgical-safety-checklist-ri-{{ $riHdrNo }}" title="Surgical Safety Checklist"
