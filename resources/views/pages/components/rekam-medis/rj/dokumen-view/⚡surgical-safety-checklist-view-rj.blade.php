<?php
// Viewer read-only "Surgical Safety Checklist" — display Rekam Medis RJ.
...
new class extends Component {
    ...
    private string $printView = 'pages.components.modul-dokumen.rj.surgical-safety-checklist-rj.cetak-surgical-safety-checklist-rj-print';
    private string $filePrefix = 'surgical-safety-checklist-rj';
    ...
    public function lihat(string $id): void
    {
        ...
        $this->dispatch('open-modal', name: "view-surgical-safety-checklist-rj-{$this->rjNo}");
    }
...
<div>
    ...
    <x-rm.dokumen-view-modal name="view-surgical-safety-checklist-rj-{{ $rjNo }}" title="Surgical Safety Checklist"
