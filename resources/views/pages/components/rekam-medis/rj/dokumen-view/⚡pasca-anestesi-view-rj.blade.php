<?php
// Viewer read-only "Pemulihan Pasca-Anestesi" — display Rekam Medis RJ.
...
new class extends Component {
    ...
    private string $filePrefix = 'pasca-anestesi-rj';
    ...
    public function lihat(string $id): void
    {
        ...
        $this->dispatch('open-modal', name: "view-pasca-anestesi-rj-{$this->rjNo}");
    }
...
<div>
    ...
    <x-rm.dokumen-view-modal name="view-pasca-anestesi-rj-{{ $rjNo }}" title="Pemulihan Pasca-Anestesi"
