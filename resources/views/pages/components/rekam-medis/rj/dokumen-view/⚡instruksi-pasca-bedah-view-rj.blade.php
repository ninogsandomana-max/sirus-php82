<?php
// Viewer read-only "Instruksi Pasca-Bedah" — display Rekam Medis RJ.
...
new class extends Component {
    ...
    private string $filePrefix = 'instruksi-pasca-bedah-rj';
    ...
    public function lihat(string $id): void
    {
        ...
        $this->dispatch('open-modal', name: "view-instruksi-pasca-bedah-rj-{$this->rjNo}");
    }
...
<div>
    ...
    <x-rm.dokumen-view-modal name="view-instruksi-pasca-bedah-rj-{{ $rjNo }}" title="Instruksi Pasca-Bedah"
