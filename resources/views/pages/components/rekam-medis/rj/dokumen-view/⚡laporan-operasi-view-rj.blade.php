<?php
// Viewer read-only "Laporan Operasi (DPJP)" — display Rekam Medis RJ.
...
new class extends Component {
    ...
    private string $filePrefix = 'laporan-operasi-rj';
    ...
    public function lihat(string $id): void
    {
        ...
        $this->dispatch('open-modal', name: "view-laporan-operasi-rj-{$this->rjNo}");
    }
...
<div>
    ...
    <x-rm.dokumen-view-modal name="view-laporan-operasi-rj-{{ $rjNo }}" title="Laporan Operasi (DPJP)"
