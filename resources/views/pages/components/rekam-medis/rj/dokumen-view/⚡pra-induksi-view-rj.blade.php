<?php
// Viewer read-only "Pra-Induksi Anestesi" — display Rekam Medis RJ.
...
new class extends Component {
    ...
    private string $filePrefix = 'pra-induksi-rj';
    ...
    public function lihat(string $id): void
    {
        ...
        $this->dispatch('open-modal', name: "view-pra-induksi-rj-{$this->rjNo}");
    }
...
<div>
    ...
    <x-rm.dokumen-view-modal name="view-pra-induksi-rj-{{ $rjNo }}" title="Pra-Induksi Anestesi"
