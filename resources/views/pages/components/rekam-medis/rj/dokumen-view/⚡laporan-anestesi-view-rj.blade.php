<?php
// Viewer read-only "Laporan Anestesi" — display Rekam Medis RJ.
...
new class extends Component {
    ...
    private string $filePrefix = 'laporan-anestesi-rj';
    ...
    public function lihat(string $id): void
    {
        ...
        $this->dispatch('open-modal', name: "view-laporan-anestesi-rj-{$this->rjNo}");
    }
...
<div>
    ...
    <x-rm.dokumen-view-modal name="view-laporan-anestesi-rj-{{ $rjNo }}" title="Laporan Anestesi"
