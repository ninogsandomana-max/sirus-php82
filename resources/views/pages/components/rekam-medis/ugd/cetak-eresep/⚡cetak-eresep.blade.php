<?php
// resources/views/pages/components/rekam-medis/ugd/cetak-eresep/cetak-eresep-ugd.blade.php
...
new class extends Component {
    ...
    public function open(string $rjNo): mixed
    {
        ...
        $pdf = Pdf::loadView('pages.components.rekam-medis.ugd.cetak-eresep.cetak-eresep-print', [
