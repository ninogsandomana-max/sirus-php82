<?php
// resources/views/pages/components/rekam-medis/ugd/etiket-obat/cetak-etiket-obat-ugd.blade.php
...
new class extends Component {
    ...
    public function open(int $rjObatNo = 0): mixed
    {
        ...
        $pdf = Pdf::loadView('pages.components.rekam-medis.ugd.etiket-obat.cetak-etiket-obat-print', ['data' => $data])->setPaper([0, 0, 170.08, 113.39]);
