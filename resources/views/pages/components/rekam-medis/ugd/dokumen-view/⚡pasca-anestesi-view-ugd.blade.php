<?php
// Viewer read-only "Pemulihan Pasca-Anestesi" — display Rekam Medis UGD.
...
new class extends Component {
    ...
    private string $printView = 'pages.components.modul-dokumen.ri.pasca-anestesi-ri.cetak-pasca-anestesi-ri-print';
    private string $filePrefix = 'pasca-anestesi-ugd';
    ...
    public function lihat(string $id): void
    {
        ...
        $this->previewHtml = $this->previewDokumenTxn($this->selected, $this->printView, $this->ttdKey, $this->ttdCodeField, $this->dataTxn(), $this->opsiSkor());
        $this->dispatch('open-modal', name: "view-pasca-anestesi-ugd-{$this->rjNo}");
    }

    public function cetak(string $id): mixed
    {
        return $this->streamCetakDokumenTxn(collect($this->list)->firstWhere('createdAt', $id), $this->printView, $this->filePrefix, $this->ttdKey, $this->ttdCodeField, $this->dataTxn(), $this->opsiSkor());
    }
...
<div>
    ...
    <x-rm.dokumen-view-modal name="view-pasca-anestesi-ugd-{{ $rjNo }}" title="Pemulihan Pasca-Anestesi"
