<?php
// Viewer read-only "Pra-Anestesi" — display Rekam Medis UGD.
...
new class extends Component {
    ...
    private string $filePrefix = 'pra-anestesi-ugd';
    ...
    public function lihat(string $id): void
    {
        ...
        $this->dispatch('open-modal', name: "view-pra-anestesi-ugd-{$this->rjNo}");
    }
...
<div>
    ...
    <x-rm.dokumen-view-modal name="view-pra-anestesi-ugd-{{ $rjNo }}" title="Pra-Anestesi"
