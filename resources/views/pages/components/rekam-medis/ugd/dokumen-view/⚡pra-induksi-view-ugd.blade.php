<?php
// Viewer read-only "Pra-Induksi Anestesi" — display Rekam Medis UGD.
...
new class extends Component {
    ...
    private string $printView = 'pages.components.modul-dokumen.ri.pra-induksi-ri.cetak-pra-induksi-ri-print';
    private string $filePrefix = 'pra-induksi-ugd';
    ...
    public function lihat(string $id): void
    {
        ...
        $this->dispatch('open-modal', name: "view-pra-induksi-ugd-{$this->rjNo}");
    }
...
<div>
    ...
    <x-rm.dokumen-view-modal name="view-pra-induksi-ugd-{{ $rjNo }}" title="Pra-Induksi Anestesi"
