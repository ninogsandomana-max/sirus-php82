<?php
// Viewer read-only "Laporan Anestesi" — display Rekam Medis UGD.
...
new class extends Component {
    ...
    private string $printView = 'pages.components.modul-dokumen.ri.laporan-anestesi-ri.cetak-laporan-anestesi-ri-print';
    private string $filePrefix = 'laporan-anestesi-ugd';
    ...
    public function lihat(string $id): void
    {
        ...
        $this->dispatch('open-modal', name: "view-laporan-anestesi-ugd-{$this->rjNo}");
    }
...
<div>
    ...
    <x-rm.dokumen-view-modal name="view-laporan-anestesi-ugd-{{ $rjNo }}" title="Laporan Anestesi"
