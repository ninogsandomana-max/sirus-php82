...
new class extends Component {
     ...
     * (https://fhir.kemkes.go.id/Questionnaire/Q0007). DISAMAKAN dengan RJ
     * (antrian-apotek-rj-actions) — formulir telaah resep itu satu instrumen
     * farmasi yang sama, hanya jalurnya berbeda; membedakan butirnya akan
     * membuat hasil telaah pasien UGD dan RJ tidak bisa dibandingkan.
     *
     ...
     *
     * Lima butir terakhir DITAMBAHKAN 21/08/2026. Sengaja di ekor: record lama
     * mendapat key baru lewat `??=` yang juga menempel di ekor, jadi urutan kartu
     * tetap sama antara record lama dan baru.
     */
