...
new class extends Component {
    use EmrUGDTrait, ServiceRequestTrait, SpecimenTrait, ObservationTrait, DiagnosticReportTrait, PenunjangKirimTrait;
    ...
    {
        $this->kirimInti($rjNo);
        $this->dispatch('ugd-satu-sehat.langkah-selesai', langkah: 'lab');
    }
