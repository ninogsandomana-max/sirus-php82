<?php
// resources/views/pages/transaksi/ugd/emr-ugd/pemeriksaan/penunjang/kamar-operasi/rm-daftar-kamar-operasi-ugd.blade.php
...
/**
 * Daftar operasi yang sudah dikirim untuk SATU kunjungan gawat darurat — baca saja.
 *
 * Model tabelnya disamakan dengan `rm-daftar-radiologi-ugd`: tabel polos tanpa
