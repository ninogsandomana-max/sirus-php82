<?php
// resources/views/pages/transaksi/ugd/emr-ugd/modul-dokumen/pengkajian-pre-op/rm-pengkajian-pre-op-ugd-actions.blade.php
...
// disimpan ke datadaftarri_json (jsonKey = pengkajianPreOpUGD). Kunci entri stabil = createdAt.
...
new class extends Component {
    ...
    private string $jsonKey = 'pengkajianPreOpUGD';
    ...
    public function mount(?string $rjNo = null, bool $disabled = false): void
    {
        ...
        $this->registerAreas(['modal-pengkajian-pre-op-ugd']);
    ...
    public function openModal(): void
    {
        ...
        $this->dispatch('open-modal', name: "rm-pengkajian-pre-op-ugd-{$this->rjNo}");
    }

    public function closeModal(): void
    {
        $this->dispatch('close-modal', name: "rm-pengkajian-pre-op-ugd-{$this->rjNo}");
    }
    ...
    public function cetak(string $createdAt)
    {
        ...
        try {
            ...
            return response()->streamDownload(fn() => print $pdf->output(), 'pengkajian-pre-op-ugd-' . ($pasien['regNo'] ?? $this->rjNo) . '.pdf');
        } catch (\Throwable $e) {
...
<div>
    ...
    {{-- ══ MODAL FORM ══ --}}
    <x-modal name="rm-pengkajian-pre-op-ugd-{{ $rjNo ?? 'init' }}" size="full" height="full" focusable>
        <div class="flex flex-col min-h-[calc(100vh-8rem)]"
            wire:key="{{ $this->renderKey('modal-pengkajian-pre-op-ugd', [$rjNo ?? 'new']) }}">
                ...
                <div class="max-w-full mx-auto space-y-4">
                    ...
                    <div
                        ...
                        <fieldset @disabled($formReadOnly) class="space-y-6">
                            ...
                            @include('pages.transaksi.ugd.emr-ugd.modul-dokumen.pengkajian-pre-op-ugd.rm-pengkajian-pre-op-ugd-data-operasi')
                            @include('pages.transaksi.ugd.emr-ugd.modul-dokumen.pengkajian-pre-op-ugd.rm-pengkajian-pre-op-ugd-keadaan-pra-bedah')
                            @include('pages.transaksi.ugd.emr-ugd.modul-dokumen.pengkajian-pre-op-ugd.rm-pengkajian-pre-op-ugd-persiapan-pasien')
                            @include('pages.transaksi.ugd.emr-ugd.modul-dokumen.pengkajian-pre-op-ugd.rm-pengkajian-pre-op-ugd-persiapan-administrasi')
                            @include('pages.transaksi.ugd.emr-ugd.modul-dokumen.pengkajian-pre-op-ugd.rm-pengkajian-pre-op-ugd-site-marking')
                            @include('pages.transaksi.ugd.emr-ugd.modul-dokumen.pengkajian-pre-op-ugd.rm-pengkajian-pre-op-ugd-ttd')
                        @include('pages.transaksi.ugd.emr-ugd.modul-dokumen.pengkajian-pre-op-ugd.rm-pengkajian-pre-op-ugd-daftar-tersimpan')
