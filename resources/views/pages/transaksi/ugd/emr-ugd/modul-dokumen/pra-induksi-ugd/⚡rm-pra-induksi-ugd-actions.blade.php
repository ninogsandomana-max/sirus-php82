<?php
// resources/views/pages/transaksi/ri/emr-ri/modul-dokumen/pra-induksi-ri/rm-pra-induksi-ugd-actions.blade.php
...
new class extends Component {
    ...
    private string $jsonKey = 'praInduksiUGD';
    ...
    public function mount(?string $rjNo = null, bool $disabled = false): void
    {
        ...
        $this->registerAreas(['modal-pra-induksi-ugd']);
    ...
    public function openModal(): void
    {
        ...
        $this->dispatch('open-modal', name: "rm-pra-induksi-ugd-{$this->rjNo}");
    }

    public function closeModal(): void
    {
        $this->dispatch('close-modal', name: "rm-pra-induksi-ugd-{$this->rjNo}");
    }
        ...
        <div class="flex flex-col min-h-[calc(100vh-8rem)]" wire:key="{{ $this->renderKey('modal-pra-induksi-ugd', [$rjNo ?? 'new']) }}">
            ...
            <div class="flex-1 px-4 py-4 bg-surface-soft/70 dark:bg-gray-950/20">
                <div class="max-w-full mx-auto space-y-4">
                    <livewire:pages::transaksi.ugd.display-pasien-ugd.display-pasien-ugd :rjNo="$rjNo" wire:key="prai-ugd-display-pasien-{{ $rjNo ?? 'init' }}" />
