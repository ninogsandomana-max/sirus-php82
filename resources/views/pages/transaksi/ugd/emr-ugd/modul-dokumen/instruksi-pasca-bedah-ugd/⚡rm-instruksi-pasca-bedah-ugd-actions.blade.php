<?php
// resources/views/pages/transaksi/ri/emr-ri/modul-dokumen/instruksi-pasca-bedah-ri/rm-instruksi-pasca-bedah-ugd-actions.blade.php
...
new class extends Component {
    ...
    private string $jsonKey = 'instruksiPascaBedahUGD';
    ...
    public function mount(?string $rjNo = null, bool $disabled = false): void
    {
        ...
        $this->registerAreas(['modal-instruksi-pasca-bedah-ugd']);
    ...
    public function openModal(): void
    {
        ...
        $this->dispatch('open-modal', name: "rm-instruksi-pasca-bedah-ugd-{$this->rjNo}");
    }

    public function closeModal(): void
    {
        $this->dispatch('close-modal', name: "rm-instruksi-pasca-bedah-ugd-{$this->rjNo}");
    }
...
<div>
    ...
    {{-- ══ MODAL FORM ══ --}}
    <x-modal name="rm-instruksi-pasca-bedah-ugd-{{ $rjNo ?? 'init' }}" size="full" height="full" focusable>
        <div class="flex flex-col min-h-[calc(100vh-8rem)]"
            wire:key="{{ $this->renderKey('modal-instruksi-pasca-bedah-ugd', [$rjNo ?? 'new']) }}">
            ...
            <div class="flex-1 px-4 py-4 overflow-y-auto bg-surface-soft/70 dark:bg-gray-950/20">
                <div class="max-w-5xl mx-auto space-y-4">
                    ...
                    <livewire:pages::transaksi.ugd.display-pasien-ugd.display-pasien-ugd :rjNo="$rjNo"
                        wire:key="ipb-ugd-display-pasien-{{ $rjNo ?? 'init' }}" />
