    ...
    public function bukaKunci(string $createdAt): void
    {
        ...
        try {
            DB::transaction(function () use ($createdAt) {
                ...
                $this->appendAdminLogRI((int) $this->riHdrNo, 'Buka kunci Asesmen Pra Induksi (' . $createdAt . ') oleh ' . $pembukaKunci . ' — TTD petugas dicabut', 'MR');
            });
    ...
    private function prefillTimDariOk(): void
    {
        ...
        try {
            $crewOk = DB::table('rstxn_oks as o')
                ...
                ->where(fn($subQuery) => $subQuery->where('o.ref_no', (int) $this->riHdrNo)->orWhere('o.rihdr_no', (int) $this->riHdrNo))
