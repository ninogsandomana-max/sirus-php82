                ...
                <div class="max-w-full mx-auto space-y-4">
                    ...
                    <div class="p-6 space-y-6 bg-canvas border border-hairline shadow-sm sm:p-8 rounded-2xl dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <fieldset @disabled($formReadOnly) class="space-y-6">
                            ...
                            @include('pages.transaksi.ri.emr-ri.modul-dokumen.pra-anestesi-ri.rm-pra-anestesi-ri-data-dasar')
                            @include('pages.transaksi.ri.emr-ri.modul-dokumen.pra-anestesi-ri.rm-pra-anestesi-ri-anamnese')
                            @include('pages.transaksi.ri.emr-ri.modul-dokumen.pra-anestesi-ri.rm-pra-anestesi-ri-antropometri-ttv')
                            @include('pages.transaksi.ri.emr-ri.modul-dokumen.pra-anestesi-ri.rm-pra-anestesi-ri-jalan-nafas')
                            @include('pages.transaksi.ri.emr-ri.modul-dokumen.pra-anestesi-ri.rm-pra-anestesi-ri-sistem-organ')
                            @include('pages.transaksi.ri.emr-ri.modul-dokumen.pra-anestesi-ri.rm-pra-anestesi-ri-kesimpulan')
                            @include('pages.transaksi.ri.emr-ri.modul-dokumen.pra-anestesi-ri.rm-pra-anestesi-ri-ttd')
                                @if (!$formReadOnly)
