<?php
// resources/views/pages/transaksi/ri/emr-ri/modul-dokumen/pasca-anestesi-ri/rm-pasca-anestesi-rj-actions.blade.php
...
new class extends Component {
    ...
    private string $jsonKey = 'pascaAnestesiRJ';
    ...
    public function mount(?string $rjNo = null, bool $disabled = false): void
    {
        ...
        $this->registerAreas(['modal-pasca-anestesi-rj']);
    ...
    public function openModal(): void
    {
        ...
        $this->dispatch('open-modal', name: "rm-pasca-anestesi-rj-{$this->rjNo}");
    }

    public function closeModal(): void
    {
        $this->dispatch('close-modal', name: "rm-pasca-anestesi-rj-{$this->rjNo}");
    }
...
<div>
    ...
    <x-modal name="rm-pasca-anestesi-rj-{{ $rjNo ?? 'init' }}" size="full" height="full" focusable>
        <div class="flex flex-col min-h-[calc(100vh-8rem)]"
            wire:key="{{ $this->renderKey('modal-pasca-anestesi-rj', [$rjNo ?? 'new']) }}">
            ...
            <div class="flex-1 px-4 py-4 overflow-y-auto bg-surface-soft/70 dark:bg-gray-950/20">
                <div class="max-w-5xl mx-auto space-y-4">
                    ...
                    <livewire:pages::transaksi.rj.display-pasien-rj.display-pasien-rj :rjNo="$rjNo"
                        wire:key="pa-rj-display-pasien-{{ $rjNo ?? 'init' }}" />
